    ...
    <section class="hero">
        <div class="carousel" id="carousel">
            <div class="carousel-slide active">
                <img src="/placeholder.svg?height=500&width=1200" alt="Campus universitario">
                <div class="carousel-content">
                    <h2>Excelencia Académica</h2>
                    <p>Formamos profesionales con las competencias del siglo XXI</p>
                </div>
            </div>
            <div class="carousel-slide">
                <img src="/placeholder.svg?height=500&width=1200" alt="Estudiantes">
                <div class="carousel-content">
                    <h2>Tecnología e Innovación</h2>
                    <p>Laboratorios equipados con la última tecnología</p>
                </div>
            </div>
            <div class="carousel-slide">
                <img src="/placeholder.svg?height=500&width=1200" alt="Graduación">
                <div class="carousel-content">
                    <h2>Tu Futuro Comienza Aquí</h2>
                    <p>Más de 20 años formando profesionales exitosos</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="about-content">
                    ...
                    <div class="about-image">
                        <img src="/placeholder.svg?height=400&width=500" alt="Instituto La Cocha">
                    </div>
                </div>
            </div>
        </section>
