...
<body>
    <div class="form-container">
        <div class="form-header">
            ...
            <p style="margin: 0.5rem 0 0 0; opacity: 0.9;">Modifique los datos de la inscripción</p>
        </div>
        ...
        <div class="form-body">
            ...
            <form method="POST" action="">
                ...
                <div class="btn-group-custom">
                    ...
                    <button type="submit" class="btn-custom btn-primary-custom">Actualizar Inscripción</button>
                </div>
            </form>
        </div>
    </div>
